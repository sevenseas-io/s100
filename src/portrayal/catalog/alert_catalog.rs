...
impl CatalogItem for AlertCatalog {
    fn id(&self) -> &str {
        self.id.as_str()
    }
...
impl ExternalFile for AlertCatalog {
...
mod tests {
    ...
    use super::{AlertCatalog, CatalogItem, FileFormat, FileType};
    ...
    fn deserialize() {
        ...
        let target = AlertCatalog::parse(node).unwrap();
